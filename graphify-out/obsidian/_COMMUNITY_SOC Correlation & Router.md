...
```dataview
TABLE source_file, type FROM #community/SOC_Correlation__Router
SORT file.name ASC
```

## Connections to other communities
- 66 edges to [[_COMMUNITY_Community 153]]
- 33 edges to [[_COMMUNITY_Community 66]]
- 26 edges to [[_COMMUNITY_Ingest API & RBAC Core]]
- 14 edges to [[_COMMUNITY_TeamsGroup Collaborator Responses]]
- 11 edges to [[_COMMUNITY_SOC Service Manager (Container Engine)]]
- 8 edges to [[_COMMUNITY_Community 388]]
- 6 edges to [[_COMMUNITY_Community 226]]
...
- 2 edges to [[_COMMUNITY_Community 1401]]
...
## Top bridge nodes
- [[socrouter.py]] - degree 162, connects to 24 communities
- [[JSONResponse]] - degree 39, connects to 8 communities
- [[build_correlation_summary()]] - degree 13, connects to 5 communities
- [[SCLCaller_2]] - degree 87, connects to 4 communities
- [[ServiceActionRequest]] - degree 19, connects to 3 communities