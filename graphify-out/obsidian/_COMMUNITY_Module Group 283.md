...
```dataview
TABLE source_file, type FROM #community/Module_Group_283
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Egress Filter & Approval]]
- 1 edge to [[_COMMUNITY_Module Group 79]]
- 1 edge to [[_COMMUNITY_Module Group 71]]
- 1 edge to [[_COMMUNITY_Module Group 240]]

## Top bridge nodes
- [[TestEgressFilterConfig]] - degree 12, connects to 4 communities
