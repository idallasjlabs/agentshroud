...
- [[Emergency Hotfix_4]] - document - docker/config/hermes/skills/i-gg/SKILL.md
...
- [[Role_100]] - document - docker/config/hermes/skills/i-gg/SKILL.md
- [[Skill Git Workflow Guardian (GIT-GUARD)_1]] - document - docker/config/hermes/skills/i-gg/SKILL.md
- [[hermesskillsi-ggSKILL]] - document - docker/config/hermes/skills/i-gg/SKILL.md

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Community_934
SORT file.name ASC
```
