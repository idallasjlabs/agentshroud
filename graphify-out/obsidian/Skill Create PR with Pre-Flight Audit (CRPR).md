...
- [[Step 3 — Audit the pending merge]] - `contains` [EXTRACTED]
- [[Step 3a — Present and resolve confirmed regressions]] - `contains` [EXTRACTED]
- [[Step 3b — Re-audit to confirm clean]] - `contains` [EXTRACTED]
- [[Step 3c — Commit the merge]] - `contains` [EXTRACTED]
- [[Step 4 — Push the branch]] - `contains` [EXTRACTED]
