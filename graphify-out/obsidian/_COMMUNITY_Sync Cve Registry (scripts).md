...
- [[main()_23]] - code - scripts/sync-cve-registry.py
...
```dataview
TABLE source_file, type FROM #community/Sync_Cve_Registry_scripts
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Generate Cve Page (scripts)]]
