...
```dataview
TABLE source_file, type FROM #community/Module_Group_708
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_healthcheck_skill_error_is_rewritten_for_form_content_field()]] - degree 4, connects to 3 communities
