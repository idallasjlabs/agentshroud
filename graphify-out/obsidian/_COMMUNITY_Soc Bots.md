...
```dataview
TABLE source_file, type FROM #community/Soc_Bots
SORT file.name ASC
```

## Connections to other communities
- 38 edges to [[_COMMUNITY_SOC Router (Collaborator Mgmt)]]
- 16 edges to [[_COMMUNITY_RBAC & Ingest Middleware]]
- 15 edges to [[_COMMUNITY_Tool ACL & Group RBAC]]
- 10 edges to [[_COMMUNITY_Event Adapter (soc)]]
- 9 edges to [[_COMMUNITY_Slack Proxy Coverage]]
- 4 edges to [[_COMMUNITY_SOC Services]]
- 3 edges to [[_COMMUNITY_Router (soc)]]
- 3 edges to [[_COMMUNITY_Soc Models]]
- 2 edges to [[_COMMUNITY_Scanner Integration (security)]]
- 1 edge to [[_COMMUNITY_Agent Cve Registry]]
- 1 edge to [[_COMMUNITY_Scanner Integration]]
- 1 edge to [[_COMMUNITY_Scanner Integration]]
- 1 edge to [[_COMMUNITY_Soc Egress Endpoints]]
- 1 edge to [[_COMMUNITY_Soc Websocket]]
- 1 edge to [[_COMMUNITY_Soc (static)]]

## Top bridge nodes
- [[test_soc_bots.py]] - degree 38, connects to 6 communities
- [[SecurityEvent_1]] - degree 20, connects to 5 communities
- [[compute_bot_scorecard()]] - degree 23, connects to 3 communities
