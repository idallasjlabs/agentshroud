...
```dataview
TABLE source_file, type FROM #community/Differential_Pii_Detector
SORT file.name ASC
```

## Connections to other communities
- 14 edges to [[_COMMUNITY_A2a Proxy]]
...
- 1 edge to [[_COMMUNITY_Tool Result Pii]]
