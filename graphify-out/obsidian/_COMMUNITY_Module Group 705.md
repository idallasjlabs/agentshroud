...
```dataview
TABLE source_file, type FROM #community/Module_Group_705
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_healthcheck_skill_sandbox_error_is_rewritten_for_form_payload()]] - degree 4, connects to 3 communities