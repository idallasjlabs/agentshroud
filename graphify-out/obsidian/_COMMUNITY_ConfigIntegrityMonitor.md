...
## Members
- [[.__init__()_98]] - code - gateway/security/config_integrity.py
...
- [[.check()_3]] - code - gateway/security/config_integrity.py
...
- [[Path_13]] - code - gateway/security/config_integrity.py
...
```dataview
TABLE source_file, type FROM #community/ConfigIntegrityMonitor
SORT file.name ASC
```
