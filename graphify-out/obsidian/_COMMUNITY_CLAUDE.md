...
```dataview
TABLE source_file, type FROM #community/CLAUDEmd
SORT file.name ASC
```
...
## Top bridge nodes
- [[AgentShroud v0.7.0 Blue Team Security Audit Report]] - degree 19, connects to 9 communities
- [[PII Sanitizer (Presidio + regex hybrid)]] - degree 7, connects to 2 communities
- [[Trust Manager  Progressive Trust System]] - degree 5, connects to 2 communities
- [[RBAC — Role-Based Access Control]] - degree 4, connects to 2 communities
- [[AgentShroud v0.7.0 Enforcement Audit Results]] - degree 20, connects to 1 community