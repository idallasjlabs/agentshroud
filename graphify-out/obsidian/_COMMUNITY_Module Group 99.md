...
- [[Path_21]] - code - gateway/tests/test_config_validation.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_99
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_SSH Proxy & Gateway Config]]
- 6 edges to [[_COMMUNITY_Agent Routing & Request Models]]
...
- [[TestParanoidConfig]] - degree 23, connects to 2 communities
- [[TestRecommendedConfig]] - degree 10, connects to 2 communities
- [[TestMinimalConfig]] - degree 9, connects to 2 communities
- [[TestAllExampleConfigsExist]] - degree 5, connects to 2 communities