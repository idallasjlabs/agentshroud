...
# Prompt: Hermes Competitive Intelligence Email (A
...
```dataview
TABLE source_file, type FROM #community/Prompt_Hermes_Competitive_Intelligence_Email_A
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Hermes Cron Jobs Reference & Recreation Guide]]

## Top bridge nodes
- [[Prompt Hermes Competitive Intelligence Email (AMPM)]] - degree 6, connects to 1 community
- [[Prompt Hermes Competitive Landscape Update (AMPM)]] - degree 6, connects to 1 community
