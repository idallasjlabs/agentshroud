...
## Connections
- [[1. Re-enable Seccomp Profiles]] - `contains` [EXTRACTED]
- [[2. Enable Read-Only Filesystem]] - `contains` [EXTRACTED]
- [[3. Remove NET_RAW Capability]] - `contains` [EXTRACTED]
- [[4. Disable mDNSBonjour Broadcasting]] - `contains` [EXTRACTED]
