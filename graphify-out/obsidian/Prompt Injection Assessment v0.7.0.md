...
## Connections
- [[3-Layer Prompt Injection Defense (PromptGuard+ContextGuard+ToolResultInjectionScanner)]] - `documents` [EXTRACTED]
- [[CRITICAL ContextGuard Never Blocks (should_block_message returns False always)]] - `identifies` [EXTRACTED]
