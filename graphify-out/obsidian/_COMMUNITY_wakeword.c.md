...
```dataview
TABLE source_file, type FROM #community/wakewordc
SORT file.name ASC
```

## Connections to other communities
- 13 edges to [[_COMMUNITY_test_ptt_state.c]]
- 11 edges to [[_COMMUNITY_app_main.c]]
- 11 edges to [[_COMMUNITY_voice_task]]
- 5 edges to [[_COMMUNITY_test_playback_state.c]]
