...
## Members
- [[.__init__()_139]] - code - gateway/tests/test_soc_services_coverage.py
- [[.__init__()_140]] - code - gateway/tests/test_soc_services_coverage.py
- [[._get_engine()]] - code - gateway/soc/services.py
- [[._logs_via_socket()]] - code - gateway/soc/services.py
- [[.close()_15]] - code - gateway/tests/test_soc_services_coverage.py
...
```dataview
TABLE source_file, type FROM #community/SOC_Services
SORT file.name ASC
```

## Connections to other communities
- 24 edges to [[_COMMUNITY_Module Group 83]]
- 19 edges to [[_COMMUNITY_SOC Services & Health Status]]
- 12 edges to [[_COMMUNITY_SOC Router & Correlation]]
- 1 edge to [[_COMMUNITY_Module Group 371]]
- 1 edge to [[_COMMUNITY_Telegram Proxy Inbound Tests]]

## Top bridge nodes
- [[ServiceManager]] - degree 104, connects to 3 communities
- [[._get_engine()]] - degree 11, connects to 2 communities
- [[test_soc_services_coverage.py]] - degree 22, connects to 1 community
- [[_FakeResponse]] - degree 13, connects to 1 community
- [[TestServiceManagerGetLogs]] - degree 10, connects to 1 community
