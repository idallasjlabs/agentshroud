...
- [[Return the CVE registry for the wrapped AI agent.      When bot_id is provided,]] - rationale - gateway/soc/router.py
...
```dataview
TABLE source_file, type FROM #community/SOC_Bots__CVE_Management
SORT file.name ASC
```

## Connections to other communities
- 32 edges to [[_COMMUNITY_SOC Router & Correlation]]
- 14 edges to [[_COMMUNITY_RBAC Configuration]]
- 14 edges to [[_COMMUNITY_Tool ACL & RBAC Config]]
- 9 edges to [[_COMMUNITY_Module Group 213]]
...
## Top bridge nodes
- [[test_soc_bots.py]] - degree 38, connects to 7 communities
- [[.test_filters_egress_log_by_bot_id()]] - degree 6, connects to 3 communities
- [[.test_filters_events_by_exact_bot_id()]] - degree 6, connects to 3 communities
- [[.test_no_bot_id_returns_all_events()]] - degree 6, connects to 3 communities
- [[TestBotSelectorFrontend]] - degree 11, connects to 2 communities