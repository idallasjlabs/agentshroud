...
# sunday-upgrade-apply.sh script

## Connections
- [[_capture_pins()]] - `calls` [EXTRACTED]
- [[_should_run()]] - `calls` [EXTRACTED]
- [[check_noop_gate()]] - `calls` [EXTRACTED]
- [[die()_1]] - `calls` [EXTRACTED]
...
- [[sunday-upgrade-apply.sh]] - `contains` [EXTRACTED]
