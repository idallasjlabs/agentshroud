...
- [[_make_proxy()_4]] - code - gateway/tests/test_slack_proxy.py
...
- 6 edges to [[_COMMUNITY_SlackAPIProxy]]
- 5 edges to [[_COMMUNITY_WebhookReceiver]]
...
- [[_make_proxy()_4]] - degree 36, connects to 2 communities
