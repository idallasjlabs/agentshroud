...
```dataview
TABLE source_file, type FROM #community/Module_Group_692
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_memory_provider_error_is_rewritten_for_json_message_field()]] - degree 4, connects to 3 communities