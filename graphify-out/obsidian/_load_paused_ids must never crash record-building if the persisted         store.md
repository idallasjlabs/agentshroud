...
# _load_paused_ids must never crash record-building if the persisted         store

## Connections
- [[dot-test_load_paused_ids_defaults_to_empty_set_on_error()]] - `rationale_for` [EXTRACTED]
