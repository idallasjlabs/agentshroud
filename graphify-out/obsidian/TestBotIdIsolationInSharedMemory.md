...
## Connections
- [[dot-test_get_user_memory_openclaw_and_hermes_are_separate_paths()]] - `method` [EXTRACTED]
- [[dot-test_hermes_memory_write_does_not_appear_in_openclaw_memory()]] - `method` [EXTRACTED]
- [[dot-test_openclaw_memory_write_does_not_appear_in_hermes_memory()]] - `method` [EXTRACTED]
- [[dot-test_shared_memory_manager_get_user_memory_accepts_bot_id()]] - `method` [EXTRACTED]
