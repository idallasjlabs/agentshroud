...
```dataview
TABLE source_file, type FROM #community/Mcp_Policy
SORT file.name ASC
```

## Connections to other communities
- 21 edges to [[_COMMUNITY_Enhanced Approval]]
...
- 1 edge to [[_COMMUNITY_A2a Policy Default Failclosed]]
- 1 edge to [[_COMMUNITY_Rbac Config (security)]]

## Top bridge nodes
- [[MCPPolicyEngine]] - degree 46, connects to 4 communities
