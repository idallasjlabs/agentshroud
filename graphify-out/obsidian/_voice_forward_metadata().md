...
## Connections
- [[Build the ``metadata`` dict attached to a voice ``forward`` request. Default…]] - `rationale_for` [EXTRACTED]
...
- [[test_voice_forward_metadata_default_off_is_empty()]] - `calls` [EXTRACTED]
