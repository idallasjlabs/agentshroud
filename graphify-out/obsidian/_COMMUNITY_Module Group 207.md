...
## Members
- [[.__init__()_134]] - code - gateway/tests/test_soc_realtime_coverage.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_207
SORT file.name ASC
```

## Connections to other communities
- 21 edges to [[_COMMUNITY_RBAC Configuration]]
- 7 edges to [[_COMMUNITY_Module Group 74]]
- 5 edges to [[_COMMUNITY_Tool ACL & RBAC Config]]
- 5 edges to [[_COMMUNITY_Module Group 120]]
- 5 edges to [[_COMMUNITY_SOC Authentication]]
...
- [[SOCWebSocketHandler_1]] - degree 14, connects to 3 communities