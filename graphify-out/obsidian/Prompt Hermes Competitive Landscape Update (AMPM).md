...
## Connections
- [[Dated Competitive Report Artifact (competitive-report-YYYY-MM-DD.md)]] - `references` [EXTRACTED]
- [[Hermes Cron Jobs Reference & Recreation Guide]] - `references` [EXTRACTED]
- [[Seed Job Hermes Competitive Landscape Update (AMPM)]] - `conceptually_related_to` [INFERRED]
- [[Silence-Over-Hallucination Principle]] - `rationale_for` [EXTRACTED]
