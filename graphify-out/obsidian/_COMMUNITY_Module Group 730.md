...
```dataview
TABLE source_file, type FROM #community/Module_Group_730
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_raw_web_fetch_json_approval_cooldown_is_scheme_port_scoped()]] - degree 4, connects to 3 communities
