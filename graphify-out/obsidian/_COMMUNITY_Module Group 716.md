...
```dataview
TABLE source_file, type FROM #community/Module_Group_716
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_urlencoded_without_content_type_empty_text_with_caption_is_still_filtered()]] - degree 4, connects to 3 communities
