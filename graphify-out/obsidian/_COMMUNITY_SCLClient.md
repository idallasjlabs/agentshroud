...
## Members
- [[.__init__()_67]] - code - gateway/cli/client.py
...
- [[.post()]] - code - gateway/cli/client.py
...
- [[Any_23]] - code - gateway/cli/client.py
...
- 8 edges to [[_COMMUNITY_test_cli_coverage.py]]
- 4 edges to [[_COMMUNITY_client_from_env()]]
- 4 edges to [[_COMMUNITY_climain.py]]
- 4 edges to [[_COMMUNITY__stub_client()]]
- 1 edge to [[_COMMUNITY__FakeHTTPResponse]]

## Top bridge nodes
- [[SCLClient]] - degree 55, connects to 5 communities
- [[.get()]] - degree 13, connects to 1 community
