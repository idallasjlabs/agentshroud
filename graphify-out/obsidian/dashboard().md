...
## Connections
- [[AgentShroud Setup Wizard (setup-wizard.html)]] - `leads_to` [INFERRED]
- [[Dashboard API Client (api-client.js)]] - `depends_on` [EXTRACTED]
- [[Dashboard Agent Trust Levels Panel]] - `contains` [EXTRACTED]
- [[Dashboard Audit Trail Panel]] - `contains` [EXTRACTED]
- [[Dashboard Kill Switch Panel (emergency termination)]] - `contains` [EXTRACTED]
