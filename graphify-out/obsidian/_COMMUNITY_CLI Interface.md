...
- [[Any_3]] - code - gateway/cli/main.py
...
- [[main()_1]] - code - gateway/cli/main.py
...
```dataview
TABLE source_file, type FROM #community/CLI_Interface
SORT file.name ASC
```

## Connections to other communities
- 12 edges to [[_COMMUNITY_Module Group 204]]
- 5 edges to [[_COMMUNITY_Module Group 106]]
- 2 edges to [[_COMMUNITY_Module Group 300]]
- 1 edge to [[_COMMUNITY_CLI & Core Gateway Routes]]

## Top bridge nodes
- [[main.py_1]] - degree 34, connects to 4 communities
