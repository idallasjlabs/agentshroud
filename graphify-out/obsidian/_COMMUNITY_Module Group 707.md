...
```dataview
TABLE source_file, type FROM #community/Module_Group_707
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_memory_provider_error_is_rewritten_for_form_caption_field()]] - degree 4, connects to 3 communities