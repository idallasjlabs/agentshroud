...
```dataview
TABLE source_file, type FROM #community/Forward_Stream
SORT file.name ASC
```

## Connections to other communities
- 10 edges to [[_COMMUNITY_Router]]
- 7 edges to [[_COMMUNITY_Forward (routes)]]
- 4 edges to [[_COMMUNITY_Config Validation & Router]]
- 4 edges to [[_COMMUNITY_Slack Proxy Coverage]]
- 1 edge to [[_COMMUNITY_Ingest API Main & Models]]
- 1 edge to [[_COMMUNITY_Tool ACL & Group RBAC]]
- 1 edge to [[_COMMUNITY_Docs Accuracy]]

## Top bridge nodes
- [[test_forward_stream.py]] - degree 42, connects to 5 communities
