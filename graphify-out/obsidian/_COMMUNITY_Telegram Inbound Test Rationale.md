...
# Telegram Inbound Test Rationale
...
```dataview
TABLE source_file, type FROM #community/Telegram_Inbound_Test_Rationale
SORT file.name ASC
```

## Connections to other communities
- 10 edges to [[_COMMUNITY_Telegram Proxy Inbound Tests]]
- 3 edges to [[_COMMUNITY_Authentication & Rate Limiting]]
- 1 edge to [[_COMMUNITY_RBAC Middleware & Ingest API]]
- 1 edge to [[_COMMUNITY_Telegram Proxy Core]]

## Top bridge nodes
- [[TestCollaboratorPromptClassifiers]] - degree 91, connects to 3 communities
