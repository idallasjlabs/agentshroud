...
# test_ws_tell_agent_command_intercepted()

## Connections
- [[A bare 'tell Hermes' must NOT reach any agent yet it only sets the sticky…]] - `rationale_for` [EXTRACTED]
- [[_agent_must_not_be_called()_2]] - `contains` [EXTRACTED]
- [[_agent_must_not_be_called()_7]] - `indirect_call` [INFERRED]
- [[_capture_synth()_2]] - `contains` [EXTRACTED]
