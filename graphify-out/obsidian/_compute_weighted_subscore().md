...
## Connections
- [[dot-test_compute_weighted_subscore_full_score()]] - `calls` [EXTRACTED]
- [[dot-test_compute_weighted_subscore_zero_for_empty_map()]] - `calls` [EXTRACTED]
- [[Return weighted sub-score as 0.0–100.0 percentage.]] - `rationale_for` [EXTRACTED]
