...
```dataview
TABLE source_file, type FROM #community/Audit_Export
SORT file.name ASC
```

## Connections to other communities
- 18 edges to [[_COMMUNITY_Ingest API Main & Models]]
...
- 1 edge to [[_COMMUNITY_Audit Archive]]
...
- [[AuditExporter]] - degree 33, connects to 3 communities
- [[AuditExportConfig_1]] - degree 24, connects to 3 communities
- [[audit_store.py]] - degree 6, connects to 3 communities
- [[audit_export.py]] - degree 7, connects to 1 community