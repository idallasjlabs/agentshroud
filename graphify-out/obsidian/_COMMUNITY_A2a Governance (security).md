...
```dataview
TABLE source_file, type FROM #community/A2a_Governance_security
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Tool Chain & CVE Triage]]
- 1 edge to [[_COMMUNITY_Start (hermes)]]
- 1 edge to [[_COMMUNITY_Subagent Governance (security)]]

## Top bridge nodes
- [[a2a_governance.py]] - degree 10, connects to 2 communities
- [[A2ADecision]] - degree 24, connects to 1 community
- [[A2AMessageType]] - degree 15, connects to 1 community
- [[Retrieve governance events with optional filters.]] - degree 2, connects to 1 community