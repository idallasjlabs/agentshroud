...
## Members
- [[.__init__()_69]] - code - gateway/security/key_rotation.py
...
- [[Any_38]] - code - gateway/security/key_rotation.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_108
SORT file.name ASC
```

## Connections to other communities
- 16 edges to [[_COMMUNITY_Module Group 93]]
- 10 edges to [[_COMMUNITY_RBAC Middleware & Ingest API]]
- 6 edges to [[_COMMUNITY_Module Group 150]]
- 5 edges to [[_COMMUNITY_Module Group 185]]
- 4 edges to [[_COMMUNITY_Module Group 223]]

## Top bridge nodes
- [[KeyRotationManager]] - degree 45, connects to 5 communities
- [[.register_credential()]] - degree 5, connects to 2 communities
- [[Any_38]] - degree 13, connects to 1 community
