...
# TrustLevel Entity (agent_id, level 0-4, violations, violation_rate, promotion_eligible)
...
- [[Trust Promotion Rules (L0→L1 immediate; L1→L2 100 actions, 0 violations, 7 days; L2→L3 1000 actions, 5% violations; L3→L4 manual only)]] - `governed_by` [EXTRACTED]
