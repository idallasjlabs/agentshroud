...
- [[MCPPermissionManager.check_tool_permission(agent_id, server_name, tool_name)]] - `contains` [EXTRACTED]
...
- [[MCPPermissionManager.set_trust_level(agent_id, level)]] - `contains` [EXTRACTED]
