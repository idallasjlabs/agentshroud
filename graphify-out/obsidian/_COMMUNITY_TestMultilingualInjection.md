...
## Members
- [[.setup_method()_20]] - code - gateway/tests/test_multilingual_injection.py
...
```dataview
TABLE source_file, type FROM #community/TestMultilingualInjection
SORT file.name ASC
```
...
- [[.setup_method()_20]] - degree 3, connects to 1 community