...
- [[client()_1]] - code - gateway/tests/test_chat_completions_alias.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_465
SORT file.name ASC
```
...
## Top bridge nodes
- [[client()_1]] - degree 2, connects to 1 community