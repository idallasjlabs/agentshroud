...
# .test_proxy_request_suppresses_duplicate_system_
...
```dataview
TABLE source_file, type FROM #community/test_proxy_request_suppresses_duplicate_system_
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_proxy_request_suppresses_duplicate_system_startup_notice()]] - degree 4, connects to 1 community