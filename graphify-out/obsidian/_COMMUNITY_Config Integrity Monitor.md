...
```dataview
TABLE source_file, type FROM #community/Config_Integrity_Monitor
SORT file.name ASC
```
...
## Top bridge nodes
- [[ConfigIntegrityMonitor]] - degree 26, connects to 1 community
- [[config_integrity.py]] - degree 2, connects to 1 community