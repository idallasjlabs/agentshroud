...
# agentshroud.yaml ssh section (SSH host allowlist, denied commands)

## Connections
- [[SSH client config (bot container — pimarvin hosts, key-only auth, StrictHostKeyChecking)]] - `complements` [EXTRACTED]
