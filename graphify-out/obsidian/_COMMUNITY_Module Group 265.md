...
## Members
- [[.__init__()_111]] - code - gateway/tests/test_dns_canvas_coverage.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_265
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Module Group 100]]
- 8 edges to [[_COMMUNITY_Module Group 275]]
- 6 edges to [[_COMMUNITY_Module Group 222]]
- 4 edges to [[_COMMUNITY_Module Group 247]]
- 3 edges to [[_COMMUNITY_Module Group 318]]
- 3 edges to [[_COMMUNITY_Module Group 430]]
- 3 edges to [[_COMMUNITY_Module Group 291]]
- 1 edge to [[_COMMUNITY_Module Group 487]]

## Top bridge nodes
- [[test_dns_canvas_coverage.py]] - degree 33, connects to 8 communities
...
- [[TestCanvasLifespan]] - degree 4, connects to 2 communities