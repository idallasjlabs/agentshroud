...
```dataview
TABLE source_file, type FROM #community/Module_Group_691
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_healthcheck_skill_sandbox_error_with_cannot_is_rewritten()]] - degree 4, connects to 3 communities