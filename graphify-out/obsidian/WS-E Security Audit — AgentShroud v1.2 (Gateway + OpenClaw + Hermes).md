...
- [[RT-2 — Inbound Encoding Bypass (FIX-RECOMMENDED)]] - `references` [EXTRACTED]
- [[RT-5 — Shared-Memory Write Poisoning (FIX-RECOMMENDED)]] - `references` [EXTRACTED]
- [[RT-6 — Owner-Identity Spoofing via forward body (FIXED)]] - `references` [EXTRACTED]
- [[Risk Callouts]] - `contains` [EXTRACTED]
