...
```dataview
TABLE source_file, type FROM #community/Background_browser-extension
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Manifest (browser-extension)]]
- 1 edge to [[_COMMUNITY_Readme (browser-extension)]]
