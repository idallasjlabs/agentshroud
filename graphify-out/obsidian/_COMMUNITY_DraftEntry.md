...
## Members
- [[.__call__()_8]] - code - gateway/tests/test_citation_verifier.py
- [[.__init__()_175]] - code - gateway/security/citation_verifier.py
- [[.__init__()_176]] - code - gateway/tests/test_citation_verifier.py
- [[.__init__()_129]] - code - gateway/web/api.py
...
- [[Return True if domain matches any pattern (exact or ``.`` wildcard). Single…]] - rationale - gateway/security/egress_config.py
...
- [[_FakeFetcher_1]] - code - gateway/tests/test_citation_verifier.py
...
```dataview
TABLE source_file, type FROM #community/DraftEntry
SORT file.name ASC
```

## Connections to other communities
- 30 edges to [[_COMMUNITY_IntelReportStore]]
- 22 edges to [[_COMMUNITY_FetchOutcome]]
- 16 edges to [[_COMMUNITY_api.py]]
...
- [[SkillGuardBlocked]] - degree 8, connects to 4 communities
