...
# spaCy NLP (en_core_web_sm — pre-installed for PII detection)

## Connections
- [[Dockerfile.gateway]] - `installs` [EXTRACTED]
- [[presidio-analyzer + presidio-anonymizer (≥2.2.0 — NER-based PII detection and redaction)]] - `depends_on` [EXTRACTED]
