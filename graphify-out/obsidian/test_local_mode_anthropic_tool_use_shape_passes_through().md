...
# test_local_mode_anthropic_tool_use_shape_passes_through()

## Connections
- [[Anthropic-format tool_use response returns the same shape in local mode.]] - `rationale_for` [EXTRACTED]
- [[_fake_forward()_4]] - `contains` [EXTRACTED]
