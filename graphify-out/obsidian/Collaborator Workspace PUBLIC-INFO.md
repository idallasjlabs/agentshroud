...
## Connections
- [[Egress Pipeline (Agent to Internet)]] - `describes` [EXTRACTED]
- [[Fail-Closed Default (deny-all baseline)]] - `references` [EXTRACTED]
- [[Inbound Security Pipeline (User to Agent)]] - `describes` [EXTRACTED]
