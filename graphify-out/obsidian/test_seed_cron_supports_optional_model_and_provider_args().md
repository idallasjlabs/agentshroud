...
# test_seed_cron_supports_optional_model_and_provider_args()

## Connections
- [[_seed_cron must accept optional $5 (model)  $6 (provider) and forward them as…]] - `rationale_for` [EXTRACTED]
