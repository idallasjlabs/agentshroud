...
# Vault Sharing Instructions (setup)
...
```dataview
TABLE source_file, type FROM #community/Vault_Sharing_Instructions_setup
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Security Implementation Verification (security)]]
- 1 edge to [[_COMMUNITY_Llm Provider Setup (setup)]]
