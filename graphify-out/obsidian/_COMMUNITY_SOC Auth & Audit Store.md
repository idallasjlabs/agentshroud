...
# SOC Auth & Audit Store

**Cohesion:** 0.02 - loosely connected
**Members:** 135 nodes

## Members
- [[dot-__init__()_89]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-__init__()_90]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-__init__()_91]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-__init__()_92]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-get_recent_entries()_1]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-is_group_admin()_2]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-is_owner()_3]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-model_dump()]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-model_dump()_1]] - code - gateway/tests/test_soc_router_coverage.py
- [[dot-require()_1]] - code - gateway/tests/test_soc_router_coverage.py
...
```dataview
TABLE source_file, type FROM #community/SOC_Auth__Audit_Store
SORT file.name ASC
```

## Connections to other communities
- 26 edges to [[_COMMUNITY_Slack Proxy & Main Endpoint Tests]]
- 11 edges to [[_COMMUNITY_Ingest API & RBAC Core]]
- 1 edge to [[_COMMUNITY_Community 329]]
- 1 edge to [[_COMMUNITY_SOC Correlation & Router]]

## Top bridge nodes
- [[test_soc_router_coverage.py]] - degree 151, connects to 4 communities
- [[FakeGroup]] - degree 13, connects to 1 community
- [[FakeCaller]] - degree 12, connects to 1 community
- [[FakeAuditStore_1]] - degree 7, connects to 1 community
- [[_Svc]] - degree 7, connects to 1 community