...
```dataview
TABLE source_file, type FROM #community/Module_Group_702
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_memory_error_without_error_keyword_is_not_rewritten_for_form_message_field()]] - degree 4, connects to 3 communities