...
- [[Context]] - document - docs/planning/v0.8/security-assessment-v0.8.0-25-domain.md
...
```dataview
TABLE source_file, type FROM #community/Community_1043
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Community 1116]]
- 1 edge to [[_COMMUNITY_Community 1424]]
