...
- [[test_bot_service_names_uses_resolved_container_name()]] - `contains` [EXTRACTED]
- [[test_config_defaults()]] - `contains` [EXTRACTED]
- [[test_entity_type_mapping()]] - `contains` [EXTRACTED]
- [[test_load_config()]] - `contains` [EXTRACTED]
- [[test_load_config_has_bots()]] - `contains` [EXTRACTED]
- [[test_load_config_registers_hermes()]] - `contains` [EXTRACTED]
