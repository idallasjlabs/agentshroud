...
# .test_self_diagnose_with_mention_is_handled_locally()

## Connections
- [[FakeRBAC]] - `calls` [EXTRACTED]
- [[Mentioned self-diagnose variant should still route to local diagnostics handler]] - `rationale_for` [EXTRACTED]
