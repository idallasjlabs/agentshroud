...
- [[.test_disconnect_swallows_engine_errors()]] - code - gateway/tests/test_web_api_coverage.py
- [[.test_freeze_pauses_bot_even_if_pause_fails()]] - code - gateway/tests/test_web_api_coverage.py
...
- [[.test_shutdown_failure_still_reports_shutdown()]] - code - gateway/tests/test_web_api_coverage.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_146
SORT file.name ASC
```

## Connections to other communities
- 22 edges to [[_COMMUNITY_Module Group 70]]
- 4 edges to [[_COMMUNITY_Module Group 310]]
- 4 edges to [[_COMMUNITY_Module Group 126]]

## Top bridge nodes
- [[_engine()]] - degree 33, connects to 2 communities
- [[TestKillSwitch_1]] - degree 12, connects to 2 communities
- [[TestServiceControl]] - degree 11, connects to 2 communities
- [[TestBotUpdates]] - degree 10, connects to 2 communities
- [[TestLogs]] - degree 8, connects to 2 communities
