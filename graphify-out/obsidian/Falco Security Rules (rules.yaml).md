...
## Connections
- [[Falco Configuration (falco.yaml)]] - `references` [EXTRACTED]
- [[Falco Rule Container Shell Spawned]] - `defines` [EXTRACTED]
- [[Falco Rule Privilege Escalation Attempt]] - `defines` [EXTRACTED]
