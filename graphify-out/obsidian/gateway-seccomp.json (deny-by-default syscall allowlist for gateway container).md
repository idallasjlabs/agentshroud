...
location: "docker/seccomp/gateway-seccomp.json"
tags:
  - graphify/document
  - graphify/EXTRACTED
...
# gateway-seccomp.json (deny-by-default syscall allowlist for gateway container)

## Connections
- [[docker-compose.yml (primary Docker Compose — services, networks, volumes, secrets)]] - `applies` [EXTRACTED]
- [[gateway service (docker-compose port 8080, read-only rootfs, 1280MB memory)]] - `applied_to` [EXTRACTED]
