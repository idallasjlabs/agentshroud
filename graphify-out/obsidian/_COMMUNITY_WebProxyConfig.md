...
## Members
- [[.__init__()_114]] - code - gateway/proxy/http_proxy.py
- [[.__init__()_115]] - code - gateway/proxy/web_proxy.py
...
- [[.reset()_1]] - code - gateway/proxy/web_proxy.py
- [[.test_allowed_domain_passes()]] - code - gateway/tests/test_web_proxy.py
...
- [[.test_case_insensitive()_1]] - code - gateway/tests/test_web_proxy.py
...
- [[.test_passthrough_allows_everything()]] - code - gateway/tests/test_web_proxy.py
...
- [[.test_ssn_in_url_flagged()]] - code - gateway/tests/test_web_proxy.py
...
- [[.test_unlisted_domain_blocked()]] - code - gateway/tests/test_web_proxy.py
...
- 50 edges to [[_COMMUNITY_WebProxy]]
- 15 edges to [[_COMMUNITY_AuditChain]]
- 10 edges to [[_COMMUNITY_HTTPConnectProxy]]
- 10 edges to [[_COMMUNITY_test_http_proxy.py]]
- 6 edges to [[_COMMUNITY_URLAnalyzer]]
- 4 edges to [[_COMMUNITY_lifespan.py]]
- 4 edges to [[_COMMUNITY_TestDataExfiltration]]
- 4 edges to [[_COMMUNITY_TestSSRFBlocking]]
...
## Top bridge nodes
- [[WebProxyConfig]] - degree 82, connects to 11 communities
- [[RateLimiter_1]] - degree 29, connects to 6 communities
- [[test_web_proxy.py]] - degree 27, connects to 4 communities
- [[DomainSettings]] - degree 24, connects to 4 communities
- [[TestAllowlistMode]] - degree 17, connects to 2 communities