...
- [[.__init__()_113]] - code - gateway/tests/test_dns_canvas_coverage.py
- [[.__init__()_114]] - code - gateway/tests/test_dns_canvas_coverage.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_222
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Module Group 265]]
- 5 edges to [[_COMMUNITY_Module Group 247]]
- 4 edges to [[_COMMUNITY_Module Group 275]]
- 3 edges to [[_COMMUNITY_Module Group 100]]
...
- [[_run_asgi()]] - degree 12, connects to 2 communities
- [[_ws_scope()]] - degree 7, connects to 1 community