...
## Connections
- [[34 Security Modules Matrix (v0.8.0 pii_sanitizer, approval_queue, security_pipeline, prompt_guard, trust_manager, egress_filter, etc.)]] - `contains` [EXTRACTED]
- [[Collaborator Isolation Architecture (no exec, no owner memory, no credentials, mandatory disclosure)]] - `describes` [EXTRACTED]
