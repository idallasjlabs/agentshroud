...
# Blocked (403 Forbidden) — All other domains, All RFC1918 addresses (10.x, 172.16.x, 192.168.x)

## Connections
- [[Connection Logged (timestamp, target domain, allowedblocked, connection count)]] - `flows_to` [EXPLICIT]
