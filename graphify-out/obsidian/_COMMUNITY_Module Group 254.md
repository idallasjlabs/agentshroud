...
```dataview
TABLE source_file, type FROM #community/Module_Group_254
SORT file.name ASC
```

## Connections to other communities
- 22 edges to [[_COMMUNITY_Module Group 128]]
- 2 edges to [[_COMMUNITY_Module Group 557]]
- 2 edges to [[_COMMUNITY_Module Group 524]]

## Top bridge nodes
- [[_get()]] - degree 12, connects to 2 communities
- [[_botParam()]] - degree 9, connects to 2 communities
- [[_loadSecurity()]] - degree 7, connects to 2 communities
- [[_loadOverview()]] - degree 5, connects to 2 communities
- [[_loadScanners()]] - degree 6, connects to 1 community
