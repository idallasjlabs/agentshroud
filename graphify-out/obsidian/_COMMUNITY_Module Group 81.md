...
```dataview
TABLE source_file, type FROM #community/Module_Group_81
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Module Group 198]]
- 3 edges to [[_COMMUNITY_Module Group 282]]
- 1 edge to [[_COMMUNITY_Module Group 670]]
- 1 edge to [[_COMMUNITY_Module Group 669]]

## Top bridge nodes
- [[TestOutboundInfoFilter]] - degree 36, connects to 4 communities
