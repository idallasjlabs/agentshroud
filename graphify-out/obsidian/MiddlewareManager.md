...
- [[dot-_analyze_request_for_rbac()]] - `method` [EXTRACTED]
- [[dot-_check_cross_session_access()]] - `method` [EXTRACTED]
- [[dot-_check_rbac_permissions()]] - `method` [EXTRACTED]
- [[dot-_critical_guard_failure()]] - `method` [EXTRACTED]
- [[dot-_enforce_session_isolation()]] - `method` [EXTRACTED]
- [[dot-_extract_file_paths()]] - `method` [EXTRACTED]
- [[dot-_extract_user_id()]] - `method` [EXTRACTED]
- [[dot-_is_owner()]] - `method` [EXTRACTED]
- [[dot-_is_path_allowed_for_user()]] - `method` [EXTRACTED]
- [[dot-_is_tool_call_request()]] - `method` [EXTRACTED]
- [[dot-_record_guard_init_failure()]] - `method` [EXTRACTED]
- [[dot-close()_14]] - `method` [EXTRACTED]
- [[dot-filter_outbound_response()]] - `method` [EXTRACTED]
- [[dot-get_alert_dispatcher()]] - `method` [EXTRACTED]
- [[dot-get_dns_filter()]] - `method` [EXTRACTED]
- [[dot-get_drift_detector()]] - `method` [EXTRACTED]
- [[dot-get_enhanced_tool_sanitizer()]] - `method` [EXTRACTED]
- [[dot-get_killswitch_monitor()]] - `method` [EXTRACTED]
- [[dot-get_log_sanitizer()]] - `method` [EXTRACTED]
- [[dot-get_multi_turn_tracker()]] - `method` [EXTRACTED]
- [[dot-get_network_validator()]] - `method` [EXTRACTED]
- [[dot-get_output_canary()]] - `method` [EXTRACTED]
- [[dot-get_rbac_manager()]] - `method` [EXTRACTED]
- [[dot-get_tool_chain_analyzer()]] - `method` [EXTRACTED]
- [[dot-middleware_manager()]] - `calls` [EXTRACTED]
- [[dot-process_request()]] - `method` [EXTRACTED]
- [[dot-process_tool_result()]] - `method` [EXTRACTED]
- [[dot-scan_tool_result()_1]] - `method` [EXTRACTED]
- [[dot-set_config()]] - `method` [EXTRACTED]
- [[dot-setup_method()]] - `calls` [EXTRACTED]
- [[dot-test_all_module_attrs_exist_after_init()]] - `calls` [EXTRACTED]
- [[dot-test_context_guard_init_raise_recorded_and_logged()]] - `calls` [EXTRACTED]
- [[dot-test_endpoint_reports_no_key_collisions_and_high_total()]] - `calls` [EXTRACTED]
- [[dot-test_full_init_success_and_getters()]] - `calls` [EXTRACTED]
- [[dot-test_init_all_modules_fail_falls_back_to_none()]] - `calls` [EXTRACTED]
- [[dot-test_middleware_set_config()]] - `calls` [EXTRACTED]
- [[dot-test_middleware_set_config_disabled()]] - `calls` [EXTRACTED]
- [[dot-test_middleware_set_config_missing()]] - `calls` [EXTRACTED]
- [[dot-test_non_critical_guard_failure_not_recorded()]] - `calls` [EXTRACTED]
- [[dot-test_process_tool_result_no_sanitizer()]] - `calls` [EXTRACTED]
- [[dot-test_process_tool_result_sanitizer_error()]] - `calls` [EXTRACTED]
