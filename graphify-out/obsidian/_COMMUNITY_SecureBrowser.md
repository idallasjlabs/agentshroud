...
## Members
- [[.__init__()_61]] - code - skills/custom/securebrowser/scripts/browse.py
...
- [[.close()_8]] - code - skills/custom/securebrowser/scripts/browse.py
...
```dataview
TABLE source_file, type FROM #community/SecureBrowser
SORT file.name ASC
```
