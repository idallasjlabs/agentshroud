...
# Test handling 1-hour time-limited approval callb
...
```dataview
TABLE source_file, type FROM #community/Test_handling_1-hour_time-limited_approval_callb
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_TestEgressTelegramNotify]]
