...
- [[test_dashboard_canary_status()]] - `calls` [EXTRACTED]
- [[test_dashboard_default_unprotected()]] - `calls` [EXTRACTED]
- [[test_dashboard_direct_access()]] - `calls` [EXTRACTED]
- [[test_dashboard_display_all_fields()]] - `calls` [EXTRACTED]
- [[test_dashboard_message_tracking()]] - `calls` [EXTRACTED]
- [[test_dashboard_pii_counting()]] - `calls` [EXTRACTED]
- [[test_dashboard_set_proxy_mode()]] - `calls` [EXTRACTED]
- [[test_dashboard_set_sidecar_mode()]] - `calls` [EXTRACTED]
