...
- [[client()_14]] - code - gateway/tests/test_v1_models_synthetic.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_498
SORT file.name ASC
```
...
## Top bridge nodes
- [[client()_14]] - degree 3, connects to 1 community
