...
# Blue Team Security Assessment — AgentShroud v0.8
...
```dataview
TABLE source_file, type FROM #community/Blue_Team_Security_Assessment__AgentShroud_v08
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_AgentShroud Phase Review — 2026-02-23]]
- 1 edge to [[_COMMUNITY_AgentShroud v0.8.0 Peer Review Round 3 (FINAL)]]
...
- 1 edge to [[_COMMUNITY_LOW Findings]]
