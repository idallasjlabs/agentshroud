...
```dataview
TABLE source_file, type FROM #community/Module_Group_211
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_Module Group 156]]
- 4 edges to [[_COMMUNITY_Module Group 152]]
- 4 edges to [[_COMMUNITY_Module Group 82]]
- 4 edges to [[_COMMUNITY_Module Group 147]]
- 3 edges to [[_COMMUNITY_Module Group 193]]
...
- [[TestComposeGenerator]] - degree 14, connects to 5 communities
- [[TestConfigRoundTrip]] - degree 8, connects to 5 communities
- [[TestManagementPage]] - degree 8, connects to 5 communities
- [[generate_compose()]] - degree 10, connects to 1 community