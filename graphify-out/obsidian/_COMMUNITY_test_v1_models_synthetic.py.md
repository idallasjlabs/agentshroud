...
- [[client()_1]] - code - gateway/tests/test_v1_models_synthetic.py
...
```dataview
TABLE source_file, type FROM #community/test_v1_models_syntheticpy
SORT file.name ASC
```
...
## Top bridge nodes
- [[client()_1]] - degree 3, connects to 1 community