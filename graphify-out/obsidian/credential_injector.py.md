...
## Connections
- [[Credential Injector — transparent credential injection for outbound requests.…]] - `rationale_for` [EXTRACTED]
- [[CredentialInjector]] - `contains` [EXTRACTED]
- [[CredentialInjectorConfig]] - `contains` [EXTRACTED]
