...
- [[description_1]] - code - browser-extension/manifest.json
...
- [[manifest.json]] - code - browser-extension/manifest.json
- [[manifest_version]] - code - browser-extension/manifest.json
- [[name_1]] - code - browser-extension/manifest.json
...
- [[version_1]] - code - browser-extension/manifest.json

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Manifest_browser-extension
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Background (browser-extension)]]

## Top bridge nodes
- [[manifest.json]] - degree 12, connects to 1 community