...
# Trust Zone 4 — Infrastructure Nodes (SSH-gated)

## Connections
- [[Diagram 11 Trust Boundary (PNG)]] - `contains` [EXPLICIT]
- [[Trust Zone 1 — Gateway (Trusted Enforcer)]] - `controls` [EXPLICIT]
- [[marvin SSH Host (approved)]] - `contains` [EXPLICIT]
- [[raspberrypi SSH Host (approved, agentshroud-bot user, id_ed25519)]] - `contains` [EXPLICIT]
- [[trillian SSH Host (approved)]] - `contains` [EXPLICIT]
