...
- [[1. Why this differs from a generic ESP32+Hermes build]] - `contains` [EXTRACTED]
- [[10. Alternatives (only if needed)]] - `contains` [EXTRACTED]
- [[11. Open decisions (confirm before server-side coding)]] - `contains` [EXTRACTED]
