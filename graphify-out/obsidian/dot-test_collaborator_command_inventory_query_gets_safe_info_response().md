...
# .test_collaborator_command_inventory_query_gets_safe_info_response()

## Connections
- [[Collaborator toolcommand inventory probes should return safe local guidance.]] - `rationale_for` [EXTRACTED]
