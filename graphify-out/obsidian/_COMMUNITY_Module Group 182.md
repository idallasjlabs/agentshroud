...
```dataview
TABLE source_file, type FROM #community/Module_Group_182
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_Module Group 101]]

## Top bridge nodes
- [[String]] - degree 4, connects to 1 community