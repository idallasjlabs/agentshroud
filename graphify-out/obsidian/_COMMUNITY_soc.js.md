...
## Members
- [[.to_dict()_14]] - code - gateway/security/soc_correlation.py
- [[Any_69]] - code - gateway/security/soc_correlation.py
...
- [[_ts()_1]] - code - gateway/soc/static/soc.js
...
```dataview
TABLE source_file, type FROM #community/socjs
SORT file.name ASC
```
...
- [[soc.js]] - degree 65, connects to 1 community
