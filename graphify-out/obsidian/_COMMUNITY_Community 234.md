...
- [[FY26 Cost Reduction Context_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
...
- [[In-Scope Departments (Cost Reduction)_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
- [[Infrastructure You Must Know_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
- [[Operating Rules (Non-Negotiable)_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
- [[Out-of-Scope Departments (Inventory & Tag Only)_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
...
- [[Savings Levers (Ranked by Impact)_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
...
- [[Target 40% Full-Year Reduction on Global Services Resources_1]] - document - docker/config/hermes/skills/i-aws/SKILL.md
