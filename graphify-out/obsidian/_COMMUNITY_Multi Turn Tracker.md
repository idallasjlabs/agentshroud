...
```dataview
TABLE source_file, type FROM #community/Multi_Turn_Tracker
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Multi Turn Tracker (security)]]
- 1 edge to [[_COMMUNITY_Path Isolation]]

## Top bridge nodes
- [[TestMultiTurnTracker_1]] - degree 27, connects to 2 communities
