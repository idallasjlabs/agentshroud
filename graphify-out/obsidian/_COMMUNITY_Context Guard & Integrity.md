...
- [[.__init__()_54]] - code - gateway/security/context_integrity.py
...
- [[.scan_tool_result()_1]] - code - gateway/security/prompt_guard.py
...
- [[Any_32]] - code - gateway/security/context_integrity.py
...
```dataview
TABLE source_file, type FROM #community/Context_Guard__Integrity
SORT file.name ASC
```

## Connections to other communities
- 16 edges to [[_COMMUNITY_Security Pipeline & Audit Chain]]
- 14 edges to [[_COMMUNITY_Module Group 79]]
- 12 edges to [[_COMMUNITY_Tool Result Sanitizer]]
- 11 edges to [[_COMMUNITY_RBAC Middleware & Ingest API]]
- 11 edges to [[_COMMUNITY_PII Sanitizer & Resource Guard]]
- 9 edges to [[_COMMUNITY_Gateway Config & Lifespan]]
- 8 edges to [[_COMMUNITY_Module Group 159]]
- 4 edges to [[_COMMUNITY_Module Group 133]]
- 4 edges to [[_COMMUNITY_Module Group 161]]
...
- 3 edges to [[_COMMUNITY_Module Group 130]]
...
- 1 edge to [[_COMMUNITY_Module Group 606]]
- 1 edge to [[_COMMUNITY_Module Group 464]]
- 1 edge to [[_COMMUNITY_Module Group 604]]
- 1 edge to [[_COMMUNITY_Module Group 605]]
...
## Top bridge nodes
- [[PromptGuard]] - degree 138, connects to 33 communities
- [[TestPromptGuardPerformance]] - degree 12, connects to 4 communities
- [[SystemPromptFingerprint]] - degree 15, connects to 2 communities
- [[test_prompt_guard.py]] - degree 10, connects to 2 communities
- [[detect_base64_payloads()]] - degree 4, connects to 2 communities