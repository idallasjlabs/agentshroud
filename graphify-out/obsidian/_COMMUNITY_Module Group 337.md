...
- [[WS wsapprovals accepts valid token in query param]] - rationale - gateway/tests/test_security_fixes.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_337
SORT file.name ASC
```
...
## Top bridge nodes
- [[TestWebSocketHandshakeAuth]] - degree 11, connects to 4 communities