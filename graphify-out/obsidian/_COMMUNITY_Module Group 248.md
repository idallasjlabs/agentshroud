...
## Members
- [[._make_proxy()_2]] - code - gateway/tests/test_telegram_proxy_multibot.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_248
SORT file.name ASC
```
...
## Top bridge nodes
- [[TestMultiBotContextvarRouting]] - degree 13, connects to 2 communities
