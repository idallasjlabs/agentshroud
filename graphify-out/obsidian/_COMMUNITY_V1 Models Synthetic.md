...
```dataview
TABLE source_file, type FROM #community/V1_Models_Synthetic
SORT file.name ASC
```
...
- [[Synthetic v1modelsid shim for hermes v0.16.0 OAuth-token preflight incompatibility]] - degree 2, connects to 1 community