...
```dataview
TABLE source_file, type FROM #community/Mcp_Permissions_proxy
SORT file.name ASC
```

## Connections to other communities
- 42 edges to [[_COMMUNITY_Mcp Proxy]]
- 33 edges to [[_COMMUNITY_Mcp Permissions]]
...
## Top bridge nodes
- [[MCPPermissionManager]] - degree 102, connects to 11 communities
