...
```dataview
TABLE source_file, type FROM #community/Module_Group_247
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Module Group 222]]
- 4 edges to [[_COMMUNITY_Module Group 265]]
- 2 edges to [[_COMMUNITY_Module Group 100]]
- 2 edges to [[_COMMUNITY_Module Group 275]]
...
- [[_http_scope()]] - degree 5, connects to 1 community
- [[.test_authorized_request_proxied_upstream()]] - degree 4, connects to 1 community
