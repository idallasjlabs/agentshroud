...
- [[main()_8]] - code - firmware/voice-terminal/test/test_playback_state/test_playback_state.c
...
```dataview
TABLE source_file, type FROM #community/Playback_State_test_playback_state
SORT file.name ASC
```

## Connections to other communities
- 15 edges to [[_COMMUNITY_Ws Client (main)]]
- 11 edges to [[_COMMUNITY_Wakeword (main)]]
- 7 edges to [[_COMMUNITY_Ptt State (test_wakeword_state)]]
- 2 edges to [[_COMMUNITY_Audio (main)]]
- 1 edge to [[_COMMUNITY_Main (src)]]
- 1 edge to [[_COMMUNITY_Ota (main)]]

## Top bridge nodes
- [[wakeword_triggered()]] - degree 15, connects to 3 communities
