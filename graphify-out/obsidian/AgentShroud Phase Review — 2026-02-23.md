...
- [[1. Changes in This Diff (Summary)]] - `contains` [EXTRACTED]
- [[1. Prior Review Verification]] - `contains` [EXTRACTED]
- [[2. Findings]] - `contains` [EXTRACTED]
- [[2. New Blue Team Changes Since Round 1]] - `contains` [EXTRACTED]
- [[2. Security Analysis]] - `contains` [EXTRACTED]
- [[2. Security Value Audit]] - `contains` [EXTRACTED]
- [[2. Security Value Audit_1]] - `contains` [EXTRACTED]
...
- [[5. Errors & Warnings Summary]] - `contains` [EXTRACTED]
- [[5. Errors & Warnings Summary_1]] - `contains` [EXTRACTED]
- [[5. Strategic Recommendations]] - `contains` [EXTRACTED]
- [[5. Summary]] - `contains` [EXTRACTED]
