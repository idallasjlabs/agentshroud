...
- [[Role_104]] - document - docker/config/openclaw/skills/i-session-prompt/SKILL.md
- [[Rules_20]] - document - docker/config/openclaw/skills/i-session-prompt/SKILL.md
- [[SKILL_180]] - document - docker/config/openclaw/skills/i-session-prompt/SKILL.md
...
- [[Trigger_2]] - document - docker/config/openclaw/skills/i-session-prompt/SKILL.md
- [[Workflow Survey → Draft → Inject → Confirm_2]] - document - docker/config/openclaw/skills/i-session-prompt/SKILL.md

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Skill_i-session-prompt
SORT file.name ASC
```
