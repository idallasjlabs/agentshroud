...
- [[.test_already_ingested_helper_swallows_read_error()_1]] - code - gateway/tests/test_daily_cve_report.py
...
- [[.test_skips_when_already_ingested_today()_1]] - code - gateway/tests/test_daily_cve_report.py
...
```dataview
TABLE source_file, type FROM #community/_sleep
SORT file.name ASC
```

## Connections to other communities
- 13 edges to [[_COMMUNITY_test_daily_cve_report.py]]
- 11 edges to [[_COMMUNITY_asyncio]]
- 3 edges to [[_COMMUNITY_.test_gives_up_and_marks_sent_after_max_retries(]]
- 1 edge to [[_COMMUNITY_gateway.security.agent_cve_registry]]

## Top bridge nodes
- [[.test_runs_ingest_records_then_skips_next_iteration()]] - degree 8, connects to 3 communities
- [[.test_ingest_records_even_when_disk_write_fails()]] - degree 9, connects to 2 communities
- [[.test_skips_ingest_when_marked_done_after_wake()]] - degree 9, connects to 2 communities
- [[.test_zero_new_cves_marks_checked_immediately()]] - degree 9, connects to 2 communities
- [[.test_per_agent_check_error_is_isolated_not_fatal()]] - degree 8, connects to 2 communities