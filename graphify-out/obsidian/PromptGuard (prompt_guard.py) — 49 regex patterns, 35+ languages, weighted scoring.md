...
- [[CVE-2026-22708 (CVSS 9.8) AI Agent Container Escape via Prompt Injection — Fully Mitigated]] - `mitigated_by` [EXTRACTED]
- [[OWASP Agentic AI (ASI) Coverage (ASI-01 through ASI-10)]] - `mapped_to` [EXTRACTED]
- [[Prompt Injection Defense Layer 1 (pattern matching), Layer 2 (unicode normalization), Layer 3 (multi-layer decoding)]] - `specifies` [INFERRED]
