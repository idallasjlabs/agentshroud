...
```dataview
TABLE source_file, type FROM #community/Module_Group_744
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_raw_web_fetch_json_non_http_scheme_does_not_queue_approval()]] - degree 4, connects to 3 communities
