...
```dataview
TABLE source_file, type FROM #community/IEC_62443_Scorecard
SORT file.name ASC
```

## Connections to other communities
- 10 edges to [[_COMMUNITY_PII Config & Test Fixtures]]
...
- [[.test_notify_collaborator_command_blocked_retries_with_unavailable_notice_on_send_failure()]] - degree 3, connects to 1 community
