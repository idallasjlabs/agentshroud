...
- [[Any_67]] - code - gateway/web/dashboard_endpoints.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_304
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Gateway Config & Lifespan]]
- 4 edges to [[_COMMUNITY_Module Group 166]]

## Top bridge nodes
- [[.append()_1]] - degree 5, connects to 1 community
- [[_check_host()]] - degree 4, connects to 1 community
- [[logs_recent()]] - degree 4, connects to 1 community
- [[ssh_hosts()_1]] - degree 4, connects to 1 community
- [[.push()_4]] - degree 3, connects to 1 community
