...
- [[Problem]] - document - .github/ISSUE_TEMPLATE/gsd.md
...
- [[Timeline]] - document - .github/ISSUE_TEMPLATE/postmortem.md
...
```dataview
TABLE source_file, type FROM #community/Postmortem_ISSUE_TEMPLATE
SORT file.name ASC
```
...
- 1 edge to [[_COMMUNITY_Copilot Cli Setup (.github)]]
