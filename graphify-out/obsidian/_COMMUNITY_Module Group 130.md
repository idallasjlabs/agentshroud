...
## Members
- [[.setup_method()_12]] - code - gateway/tests/test_multilingual_injection.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_130
SORT file.name ASC
```
...
- [[.setup_method()_12]] - degree 3, connects to 1 community
- [[test_multilingual_injection.py]] - degree 2, connects to 1 community