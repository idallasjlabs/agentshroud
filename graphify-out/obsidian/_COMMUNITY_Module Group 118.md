...
```dataview
TABLE source_file, type FROM #community/Module_Group_118
SORT file.name ASC
```
...
## Top bridge nodes
- [[TestPathIsolationManager]] - degree 24, connects to 1 community
- [[.config()_4]] - degree 3, connects to 1 community
- [[.manager()_1]] - degree 3, connects to 1 community