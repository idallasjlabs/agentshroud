...
## Connections
- [[dot-test_contains_allowed_tools()]] - `calls` [EXTRACTED]
- [[dot-test_contains_group_and_project()]] - `calls` [EXTRACTED]
- [[Build the system-prompt injection for project_scoped mode.]] - `rationale_for` [EXTRACTED]
