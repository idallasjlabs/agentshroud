...
- [[_apply_agent_cb()]] - `contains` [EXTRACTED]
- [[_apply_state_cb()]] - `contains` [EXTRACTED]
- [[_find_canvas()]] - `contains` [EXTRACTED]
- [[_report_and_place_canvas()]] - `contains` [EXTRACTED]
- [[_state_to_emotion()]] - `contains` [EXTRACTED]
