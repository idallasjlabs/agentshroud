...
## Members
- [[.__init__()_13]] - code - gateway/proxy/dns_forwarder.py
- [[.close()_8]] - code - gateway/tests/test_dns_canvas_coverage.py
...
- [[main()_2]] - code - gateway/proxy/dns_forwarder.py
- [[start_dns_forwarder()]] - code - gateway/proxy/dns_forwarder.py

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Module_Group_275
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Module Group 100]]
- 8 edges to [[_COMMUNITY_Module Group 265]]
- 4 edges to [[_COMMUNITY_Gateway Config & Lifespan]]
- 4 edges to [[_COMMUNITY_Module Group 318]]
- 4 edges to [[_COMMUNITY_Module Group 291]]
- 4 edges to [[_COMMUNITY_Module Group 222]]
- 2 edges to [[_COMMUNITY_Module Group 430]]
- 2 edges to [[_COMMUNITY_Module Group 247]]
- 1 edge to [[_COMMUNITY_Module Group 487]]

## Top bridge nodes
- [[DNSForwarderProtocol]] - degree 31, connects to 8 communities
