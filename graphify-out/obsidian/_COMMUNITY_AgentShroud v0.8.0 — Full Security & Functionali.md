...
# AgentShroud v0.8.0 — Full Security & Functionali
...
- [[Architecture_9]] - document - docs/claude-security-audit-prompt.md
...
- [[Output Format_12]] - document - docs/claude-security-audit-prompt.md
...
- [[What is AgentShroud_3]] - document - docs/claude-security-audit-prompt.md
...
```dataview
TABLE source_file, type FROM #community/AgentShroud_v080__Full_Security__Functionali
SORT file.name ASC
```
