...
```dataview
TABLE source_file, type FROM #community/Egress_Callback_Stale
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_Telegram Egress Notify (proxy)]]
- 4 edges to [[_COMMUNITY_Telegram Egress Notify (proxy)]]
