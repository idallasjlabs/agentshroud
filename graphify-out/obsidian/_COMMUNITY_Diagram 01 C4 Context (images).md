...
```dataview
TABLE source_file, type FROM #community/Diagram_01_C4_Context_images
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Trust Manager.py (Security Modules)]]
- 1 edge to [[_COMMUNITY_Deployment Diagram (architecture)]]
- 1 edge to [[_COMMUNITY_Adr 006 Multi Runtime (adr)]]
