...
- [[_determine_iec_sl()]] - `calls` [EXTRACTED]
- [[_evaluate_mandatory_gates()]] - `calls` [EXTRACTED]
- [[_score_access_control_authorization()]] - `calls` [EXTRACTED]
- [[_score_agent_behavior_integrity()]] - `calls` [EXTRACTED]
- [[_score_agent_identity_nhi()]] - `calls` [EXTRACTED]
...
- [[_score_human_in_the_loop()]] - `calls` [EXTRACTED]
...
- [[_score_inter_agent_trust()]] - `calls` [EXTRACTED]
