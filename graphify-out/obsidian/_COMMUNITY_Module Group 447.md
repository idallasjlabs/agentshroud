...
```dataview
TABLE source_file, type FROM #community/Module_Group_447
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_Module Group 179]]
- 2 edges to [[_COMMUNITY_Module Group 162]]
- 1 edge to [[_COMMUNITY_Module Group 438]]
- 1 edge to [[_COMMUNITY_Module Group 382]]

## Top bridge nodes
- [[TestParamSanitization]] - degree 17, connects to 4 communities
- [[.analyzer()]] - degree 2, connects to 1 community