...
## Connections
- [[Command Injection Threat — regex + no-shell exec mitigation]] - `conceptually_related_to` [EXTRACTED]
- [[Host SpoofingMITM Threat — TOFU model residual risk]] - `conceptually_related_to` [EXTRACTED]
- [[Open Findings (C3-C5, H4-H7, M1-M5)]] - `semantically_similar_to` [INFERRED]
