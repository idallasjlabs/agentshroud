...
```dataview
TABLE source_file, type FROM #community/Skill_i-data
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Skill (i-aws)]]
- 1 edge to [[_COMMUNITY_Readme (i-cicd)]]
- 1 edge to [[_COMMUNITY_Skill (i-cicd)]]
