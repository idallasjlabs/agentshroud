...
## Connections
- [[asb (AgentShroud bot helper)]] - `semantically_similar_to` [INFERRED]
...
- [[switch_model.sh script]] - `contains` [EXTRACTED]
- [[test_hermes_model_resolver.py]] - `references` [EXTRACTED]
- [[upsert_env_value()]] - `defines` [EXTRACTED]
- [[usage()_4]] - `defines` [EXTRACTED]
