...
type: "document"
community: "Hexstrike Proxy Plan (planning)"
location: "L1"
tags:
  - graphify/document
  - graphify/EXTRACTED
  - community/Hexstrike_Proxy_Plan_planning
---
...
- [[Out of scope (explicitly)]] - `contains` [EXTRACTED]
- [[Policy levers to configure (per engagement)]] - `contains` [EXTRACTED]
- [[Proposed architecture]] - `contains` [EXTRACTED]
- [[The core tension (and its resolution)]] - `contains` [EXTRACTED]
...
#graphify/document #graphify/EXTRACTED #community/Hexstrike_Proxy_Plan_planning