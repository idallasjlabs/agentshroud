...
```dataview
TABLE source_file, type FROM #community/Module_Group_678
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_collaborator_multiturn_block_text_is_normalized_to_protected_notice()]] - degree 4, connects to 3 communities