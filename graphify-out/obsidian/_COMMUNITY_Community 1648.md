...
```dataview
TABLE source_file, type FROM #community/Community_1648
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_collaborator_security_monitoring_threshold_notice_is_normalized_form()]] - degree 4, connects to 3 communities