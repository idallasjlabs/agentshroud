...
```dataview
TABLE source_file, type FROM #community/test_gemini_openai_translatorpy
SORT file.name ASC
```

## Connections to other communities
- 5 edges to [[_COMMUNITY_LLMProxy.proxy_messages]]
...
- [[openai_to_gemini_request()]] - degree 12, connects to 2 communities
- [[openai_to_gemini_response()]] - degree 9, connects to 2 communities
- [[gemini_to_openai_response()]] - degree 9, connects to 1 community
- [[gemini_failover_unsupported_reason()]] - degree 8, connects to 1 community