...
## Connections
- [[ContainerSnapshot_1]] - `contains` [EXTRACTED]
- [[DriftAlert_1]] - `contains` [EXTRACTED]
- [[DriftDetector_1]] - `contains` [EXTRACTED]
- [[agent_isolation.py (Security)]] - `references` [EXTRACTED]
