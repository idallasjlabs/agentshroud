...
- [[test_default_summary_wrapped_agent_openclaw()]] - `contains` [EXTRACTED]
...
- [[test_hermes_all_defense_layers_are_lists()]] - `contains` [EXTRACTED]
- [[test_hermes_all_required_titles_present()]] - `contains` [EXTRACTED]
- [[test_hermes_all_severities_valid()]] - `contains` [EXTRACTED]
- [[test_hermes_all_statuses_valid()]] - `contains` [EXTRACTED]
- [[test_hermes_auth_entries_use_gateway_auth_gate()]] - `contains` [EXTRACTED]
- [[test_hermes_by_severity_totals_match()]] - `contains` [EXTRACTED]
- [[test_hermes_by_status_totals_match()]] - `contains` [EXTRACTED]
- [[test_hermes_command_injection_high_severity()]] - `contains` [EXTRACTED]
- [[test_hermes_cve_registry_public_alias()]] - `contains` [EXTRACTED]
- [[test_hermes_summary_count_is_fourteen()]] - `contains` [EXTRACTED]
- [[test_hermes_summary_count_matches_registry()]] - `contains` [EXTRACTED]
- [[test_hermes_summary_cves_is_hermes_list()]] - `contains` [EXTRACTED]
- [[test_hermes_summary_keys()]] - `contains` [EXTRACTED]
- [[test_hermes_summary_wrapped_agent_is_hermes()]] - `contains` [EXTRACTED]
- [[test_hermes_symlink_entry_upstream_fix()]] - `contains` [EXTRACTED]
...
- [[test_openclaw_by_severity_totals_match()]] - `contains` [EXTRACTED]
- [[test_openclaw_by_status_totals_match()]] - `contains` [EXTRACTED]
- [[test_openclaw_first_entry_is_feishu_media_download()]] - `contains` [EXTRACTED]
- [[test_openclaw_has_some_confident_ghsa_matches()]] - `contains` [EXTRACTED]
- [[test_openclaw_match_counts_are_consistent()]] - `contains` [EXTRACTED]
