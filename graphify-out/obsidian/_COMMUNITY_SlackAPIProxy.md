...
## Members
- [[.__init__()_58]] - code - gateway/proxy/slack_proxy.py
- [[.__init__()_111]] - code - gateway/tests/test_slack_proxy_coverage.py
...
- [[SlackAPIProxy_1]] - code - gateway/proxy/slack_proxy.py
...
```dataview
TABLE source_file, type FROM #community/SlackAPIProxy
SORT file.name ASC
```

## Connections to other communities
- 30 edges to [[_COMMUNITY_AsyncMock]]
- 6 edges to [[_COMMUNITY__make_proxy()]]
- 2 edges to [[_COMMUNITY_TestHandleEvent]]
- 2 edges to [[_COMMUNITY_TelegramAPIProxy]]
- 2 edges to [[_COMMUNITY_SlackSocketClient]]
...
## Top bridge nodes
- [[SlackAPIProxy_1]] - degree 38, connects to 8 communities
