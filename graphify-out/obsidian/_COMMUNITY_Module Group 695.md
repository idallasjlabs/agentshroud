...
```dataview
TABLE source_file, type FROM #community/Module_Group_695
SORT file.name ASC
```
...
## Top bridge nodes
- [[.test_memory_provider_error_slash_variant_is_rewritten_for_form_payload()]] - degree 4, connects to 3 communities
