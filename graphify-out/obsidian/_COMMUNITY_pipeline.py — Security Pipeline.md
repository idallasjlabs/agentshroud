...
- [[Key Classes]] - document - docs/vault/02 - Modules/Proxy Layer/pipeline.py.md
...
```dataview
TABLE source_file, type FROM #community/pipelinepy__Security_Pipeline
SORT file.name ASC
```
...
## Top bridge nodes
- [[Key Classes]] - degree 5, connects to 1 community