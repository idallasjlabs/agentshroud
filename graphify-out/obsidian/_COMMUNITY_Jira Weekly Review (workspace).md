...
```dataview
TABLE source_file, type FROM #community/Jira_Weekly_Review_workspace
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Jira Dev Ticket (workspace)]]
- 1 edge to [[_COMMUNITY_Jira Dev Ticket (workspace)]]
- 1 edge to [[_COMMUNITY_Start Agentshroud (scripts)]]
- 1 edge to [[_COMMUNITY_Jira Weekly Review]]
