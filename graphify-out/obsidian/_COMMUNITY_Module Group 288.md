...
```dataview
TABLE source_file, type FROM #community/Module_Group_288
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Module Group 383]]
- 2 edges to [[_COMMUNITY_Module Group 384]]
...
- 1 edge to [[_COMMUNITY_Module Group 467]]

## Top bridge nodes
- [[CredentialInjector]] - degree 13, connects to 6 communities
- [[TestCredentialInjector]] - degree 11, connects to 1 community
