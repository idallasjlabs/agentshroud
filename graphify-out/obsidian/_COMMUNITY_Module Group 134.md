...
```dataview
TABLE source_file, type FROM #community/Module_Group_134
SORT file.name ASC
```

## Connections to other communities
- 27 edges to [[_COMMUNITY_Security Scanner Integration]]
- 19 edges to [[_COMMUNITY_Scanner Integration Tests]]
...
- [[.test_clean_tools_improve_score()]] - degree 8, connects to 1 community