...
```dataview
TABLE source_file, type FROM #community/Module_Group_388
SORT file.name ASC
```

## Connections to other communities
- 6 edges to [[_COMMUNITY_Module Group 143]]
- 4 edges to [[_COMMUNITY_Module Group 142]]
- 2 edges to [[_COMMUNITY_Module Group 168]]
- 1 edge to [[_COMMUNITY_Module Group 355]]

## Top bridge nodes
- [[TestMemorySecurityIntegration]] - degree 15, connects to 4 communities
- [[.setup_method()_10]] - degree 5, connects to 3 communities