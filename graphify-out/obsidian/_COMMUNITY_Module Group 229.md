...
- [[Request_6]] - code - gateway/web/installer.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_229
SORT file.name ASC
```
...
- 2 edges to [[_COMMUNITY_Module Group 82]]
...
## Top bridge nodes
- [[TestDetectRuntime]] - degree 11, connects to 6 communities
- [[detect_runtime()]] - degree 14, connects to 4 communities
- [[installer.py]] - degree 9, connects to 1 community
