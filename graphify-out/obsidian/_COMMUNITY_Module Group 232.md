...
- [[.test_requires_auth()_2]] - code - gateway/tests/test_mcp_proxy_endpoint.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_232
SORT file.name ASC
```
...
## Top bridge nodes
- [[TestMCPProxyEndpoint_1]] - degree 12, connects to 2 communities