...
```dataview
TABLE source_file, type FROM #community/Module_Group_119
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_Module Group 179]]
- 3 edges to [[_COMMUNITY_Module Group 162]]
- 1 edge to [[_COMMUNITY_Module Group 438]]
- 1 edge to [[_COMMUNITY_Module Group 382]]

## Top bridge nodes
- [[TestToolChainAnalyzer_1]] - degree 32, connects to 4 communities