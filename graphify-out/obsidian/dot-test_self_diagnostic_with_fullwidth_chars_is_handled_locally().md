...
# .test_self_diagnostic_with_fullwidth_chars_is_handled_locally()
...
- [[Unicode fullwidth self-diagnostic command should still be local-handled.]] - `rationale_for` [EXTRACTED]
