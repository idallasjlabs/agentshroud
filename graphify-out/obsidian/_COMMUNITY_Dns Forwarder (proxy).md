...
- [[main()_11]] - code - gateway/proxy/dns_forwarder.py
- [[start_dns_forwarder()]] - code - gateway/proxy/dns_forwarder.py

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Dns_Forwarder_proxy
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Dns Blocklist]]
- 8 edges to [[_COMMUNITY_Dns Canvas Coverage]]
- 6 edges to [[_COMMUNITY_Dns Canvas Coverage]]
- 4 edges to [[_COMMUNITY_Dns Canvas Coverage]]
- 4 edges to [[_COMMUNITY_Dns Canvas Coverage]]
- 3 edges to [[_COMMUNITY_Security Audit & Watchtower Tests]]
- 2 edges to [[_COMMUNITY_Dns Canvas Coverage]]
...
- [[start_dns_forwarder()]] - degree 8, connects to 2 communities
