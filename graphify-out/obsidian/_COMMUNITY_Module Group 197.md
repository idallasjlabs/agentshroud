...
## Members
- [[.__init__()_67]] - code - gateway/security/heuristic_classifier.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_197
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_Module Group 159]]
- 5 edges to [[_COMMUNITY_Module Group 284]]
...
## Top bridge nodes
- [[HeuristicClassifier]] - degree 26, connects to 7 communities
- [[ClassificationResult]] - degree 10, connects to 1 community
- [[test_heuristic_classifier.py]] - degree 3, connects to 1 community
- [[.setup_method()_6]] - degree 2, connects to 1 community
- [[.test_classification_result_properties()]] - degree 2, connects to 1 community