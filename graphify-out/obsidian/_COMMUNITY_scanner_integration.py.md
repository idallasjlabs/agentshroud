...
- [[Path_41]] - code - gateway/security/scanner_integration.py
...
- 27 edges to [[_COMMUNITY_compute_scorecard()]]
- 13 edges to [[_COMMUNITY_test_scanner_integration.py]]
- 11 edges to [[_COMMUNITY_Any]]
- 8 edges to [[_COMMUNITY_wazuh_client.py]]
- 5 edges to [[_COMMUNITY_get_trivy_summary()]]
- 4 edges to [[_COMMUNITY_test_scorecard_integrity.py]]
- 2 edges to [[_COMMUNITY__score_secure_development()]]
- 2 edges to [[_COMMUNITY_falco_monitor.py]]
- 2 edges to [[_COMMUNITY__score_compliance_auditing()]]
...
- [[Path_41]] - degree 34, connects to 6 communities
