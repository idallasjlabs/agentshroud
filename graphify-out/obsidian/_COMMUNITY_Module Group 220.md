...
```dataview
TABLE source_file, type FROM #community/Module_Group_220
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_Module Group 352]]
...
- [[llm_quota_detector.py]] - degree 6, connects to 2 communities
- [[test_llm_quota_detector.py]] - degree 15, connects to 1 community
