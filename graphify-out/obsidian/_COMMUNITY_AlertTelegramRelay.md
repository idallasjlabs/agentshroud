...
## Members
- [[.__call__()_3]] - code - gateway/ingest_api/alert_telegram_relay.py
- [[.__call__()_4]] - code - gateway/tests/test_alert_telegram_relay.py
- [[.__init__()_85]] - code - gateway/ingest_api/alert_telegram_relay.py
- [[.__init__()_86]] - code - gateway/tests/test_alert_telegram_relay.py
...
- [[._handle()_1]] - code - gateway/ingest_api/alert_telegram_relay.py
...
- [[Any_29]] - code - gateway/ingest_api/alert_telegram_relay.py
...
```dataview
TABLE source_file, type FROM #community/AlertTelegramRelay
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_make_event()]]
