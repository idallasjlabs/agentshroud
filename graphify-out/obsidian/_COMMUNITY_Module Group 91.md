...
## Members
- [[.__init__()_82]] - code - gateway/security/output_canary.py
...
- [[.setup_method()_16]] - code - gateway/tests/test_output_canary.py
...
- [[Any_47]] - code - gateway/security/output_canary.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_91
SORT file.name ASC
```
...
## Top bridge nodes
- [[TestOutputCanary]] - degree 19, connects to 1 community
- [[._scan_for_canary()]] - degree 5, connects to 1 community
- [[.check_response()]] - degree 4, connects to 1 community
- [[test_output_canary.py]] - degree 4, connects to 1 community
- [[.setup_method()_16]] - degree 4, connects to 1 community
