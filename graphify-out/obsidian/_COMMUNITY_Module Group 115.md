...
## Members
- [[.__init__()_49]] - code - gateway/security/canary_tripwire.py
...
```dataview
TABLE source_file, type FROM #community/Module_Group_115
SORT file.name ASC
```

## Connections to other communities
- 14 edges to [[_COMMUNITY_Security Pipeline & Audit Chain]]
- 2 edges to [[_COMMUNITY_RBAC Middleware & Ingest API]]
- 2 edges to [[_COMMUNITY_Gateway Config & Lifespan]]

## Top bridge nodes
- [[CanaryTripwire]] - degree 34, connects to 3 communities