...
# Group Config & Collaborator Responses
...
```dataview
TABLE source_file, type FROM #community/Group_Config__Collaborator_Responses
SORT file.name ASC
```

## Connections to other communities
- 21 edges to [[_COMMUNITY_Tool ACL & Group RBAC]]
- 19 edges to [[_COMMUNITY_Shared Memory Write Acl]]
- 18 edges to [[_COMMUNITY_SOC Router (Collaborator Mgmt)]]
- 16 edges to [[_COMMUNITY_Telegram Proxy Core]]
- 14 edges to [[_COMMUNITY_Group Workspace Manager]]
...
- 2 edges to [[_COMMUNITY_Start (hermes)]]
- 2 edges to [[_COMMUNITY_Ingest API Main & Models]]
- 2 edges to [[_COMMUNITY_Readme (dashboard)]]
...
- 1 edge to [[_COMMUNITY_Telegram Gateway Relay (proxy)]]
...
- 1 edge to [[_COMMUNITY_Egress Retry (security)]]
- 1 edge to [[_COMMUNITY_Rbac]]
- 1 edge to [[_COMMUNITY_Security Hardening]]
- 1 edge to [[_COMMUNITY_Group Rbac]]

## Top bridge nodes
- [[telegram_proxy.py]] - degree 41, connects to 20 communities
