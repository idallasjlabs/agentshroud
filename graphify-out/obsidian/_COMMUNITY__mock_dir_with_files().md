...
```dataview
TABLE source_file, type FROM #community/_mock_dir_with_files
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_test_scorecard_scoring.py]]
- 3 edges to [[_COMMUNITY__mock_dir_with_fresh_files()]]
- 2 edges to [[_COMMUNITY_TestIsFresh]]
- 2 edges to [[_COMMUNITY_TestScoreMalwareDefense]]
