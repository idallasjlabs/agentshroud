...
```dataview
TABLE source_file, type FROM #community/Module_Group_156
SORT file.name ASC
```

## Connections to other communities
- 7 edges to [[_COMMUNITY_Module Group 211]]
- 6 edges to [[_COMMUNITY_Module Group 229]]
- 6 edges to [[_COMMUNITY_Web API & Dashboard UI]]
- 3 edges to [[_COMMUNITY_Module Group 371]]
- 3 edges to [[_COMMUNITY_Module Group 152]]
- 3 edges to [[_COMMUNITY_Module Group 82]]
- 3 edges to [[_COMMUNITY_Module Group 147]]
- 2 edges to [[_COMMUNITY_Module Group 281]]
- 2 edges to [[_COMMUNITY_Module Group 193]]
...
## Top bridge nodes
- [[test_runtime_engines.py]] - degree 29, connects to 12 communities
- [[TestSecurityFeatures]] - degree 16, connects to 5 communities
- [[get_status()]] - degree 6, connects to 3 communities
- [[security.py]] - degree 9, connects to 2 communities
- [[get_security_comparison()]] - degree 9, connects to 2 communities
