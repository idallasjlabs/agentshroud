...
```dataview
TABLE source_file, type FROM #community/Module_Group_296
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_RBAC Configuration]]
- 3 edges to [[_COMMUNITY_Module Group 120]]
- 3 edges to [[_COMMUNITY_SOC Authentication]]
- 3 edges to [[_COMMUNITY_Module Group 74]]
- 2 edges to [[_COMMUNITY_Tool ACL & RBAC Config]]

## Top bridge nodes
- [[TestCollectRecentEvents]] - degree 11, connects to 5 communities
