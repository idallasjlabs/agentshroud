...
- [[test_a2a_task_ownership_violation_has_a_configured_penalty_heavier_than_generic_policy()]] - `contains` [EXTRACTED]
- [[test_a2a_violation_types_exist()]] - `contains` [EXTRACTED]
- [[test_generic_denial_does_not_record_a2a_specific_violation_types()]] - `contains` [EXTRACTED]
- [[test_proxy_without_trust_manager_does_not_raise()]] - `contains` [EXTRACTED]
- [[test_ssrf_callback_rejection_triggers_severe_demotion()]] - `contains` [EXTRACTED]
