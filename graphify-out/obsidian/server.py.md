...
- [[_call_llm_stream()]] - `contains` [EXTRACTED]
- [[_effective_voice_model()]] - `contains` [EXTRACTED]
- [[_get_firmware_etag()]] - `contains` [EXTRACTED]
- [[_is_volume_query()]] - `contains` [EXTRACTED]
- [[_keepalive()]] - `contains` [EXTRACTED]
- [[_lifespan()]] - `contains` [EXTRACTED]
- [[_load_ota_tokens()]] - `contains` [EXTRACTED]
- [[_ota_token_ok()]] - `contains` [EXTRACTED]
- [[_parse_model_switch_command()]] - `contains` [EXTRACTED]
- [[_parse_volume_command()]] - `contains` [EXTRACTED]
- [[_record_turn_latency()]] - `contains` [EXTRACTED]
- [[_send_state()]] - `contains` [EXTRACTED]
