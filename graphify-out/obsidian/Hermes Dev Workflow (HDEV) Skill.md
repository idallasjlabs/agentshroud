...
## Connections
- [[Codex CLI (codex exec  Codex -p)]] - `references` [EXTRACTED]
- [[GIT-GUARD Skill]] - `semantically_similar_to` [INFERRED]
- [[GSDE&G Development Master Checklist Skill]] - `semantically_similar_to` [INFERRED]
- [[Gemini CLI (--skip-trust)]] - `references` [EXTRACTED]
