...
```dataview
TABLE source_file, type FROM #community/Client_cli
SORT file.name ASC
```

## Connections to other communities
- 8 edges to [[_COMMUNITY_Cli Coverage]]
- 4 edges to [[_COMMUNITY_Cli Coverage]]
- 4 edges to [[_COMMUNITY_Main (cli)]]
- 4 edges to [[_COMMUNITY_Cli Coverage]]
- 1 edge to [[_COMMUNITY_Cli Coverage]]
