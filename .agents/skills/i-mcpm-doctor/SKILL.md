---
description: "Diagnose MCP server connectivity and configuration issues with automated checks and fixes"
---
...
**Fix:** Run `/i-mcpm-aws-profile` to configure AWS credentials
...
## Related Skills
- `/i-mcpm-auth-reset` - Reset MCP authentication
