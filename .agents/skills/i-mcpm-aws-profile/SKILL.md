---
description: "Configure and switch AWS profiles for MCP operations including SSO and multi-account access"
---
...
# Option 2: Restart Codex with profile set
...
- Restart Codex after changing profiles
