...
**Command:** `/i-sec-offense` (Claude Code) | paste `.gemini/agents/sec-offense.md` (Gemini/Codex)
...
Invoke with `/i-sec-offense` in Claude Code, or `@sec-offense` in Gemini/Codex CLI.
