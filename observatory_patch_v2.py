...
# 1. Add observatory mode and auto_revert_task to AppState class - only once
if 'observatory_mode: dict' not in content:
    content = re.sub(
...
# 2. Add observatory mode initialization after event bus initialization - only once  
if 'app_state.observatory_mode' not in content:
    observatory_init = '''
...
print('Observatory mode properly added to main.py')
