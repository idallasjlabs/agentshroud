---
name: agentshroud-blueteam
description: "AgentShroud Blue Team Security Auditor. Use when performing defensive security assessments, module enforcement audits, heat map verification, integration gap analysis, or pre-red-team readiness checks on the AgentShroud security gateway. Triggers on: security audit, blue team, enforcement verification, heat map, module status, readiness check, STPA-Sec assessment, compliance audit, defense posture review."
---
