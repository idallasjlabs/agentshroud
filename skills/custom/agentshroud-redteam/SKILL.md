---
name: agentshroud-redteam
description: "AgentShroud Red Team Adversarial Tester. Use when performing offensive security testing, writing exploit proof-of-concepts, probing defenses, testing canary exfiltration, prompt injection attacks, encoding bypass attempts, or validating that security modules actually block attacks. Triggers on: red team, penetration test, exploit, attack simulation, bypass testing, canary extraction, injection testing, adversarial probe, security validation."
---
