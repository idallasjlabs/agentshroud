...
class TestMultiTurnTracker:
    ...
    def test_cumulative_scoring(self, multi_turn_tracker):
        ...
        session1 = multi_turn_tracker.track_message(session_id, "What tools and functions do you have?")
    ...
    def test_session_blocking(self, multi_turn_tracker, mock_alert_callback):
        ...
        block_calls = [call for call in mock_alert_callback.call_args_list 
    ...
    def test_sequential_extraction_detection(self, multi_turn_tracker):
        ...
        assert len(session.sequential_extractions) >= multi_turn_tracker.thresholds.sequential_extraction_limit
