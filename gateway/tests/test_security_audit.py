...
class TestAuth:
    ...
    def test_oauth_confused_deputy(self):
        from security.oauth_security import ConfusedDeputyError
        assert issubclass(ConfusedDeputyError, Exception)

    def test_oauth_pkce_violation(self):
        from security.oauth_security import PKCEViolation
...
class TestNetworkSecurity:
    ...
    def test_egress_monitor_loaded(self):
        from security.egress_monitor import EgressEvent
    ...
    def test_oauth_redirect_mismatch(self):
        from security.oauth_security import RedirectMismatch
...
class TestAuditTrail:
    ...
    def test_canary_system_importable(self):
        from security.canary import run_canary, CanaryResult
        assert run_canary is not None

    def test_health_report_importable(self):
        from security import health_report
...
class TestContainerSecurity:
    ...
    def test_trivy_binary_not_found(self):
        from security.trivy_report import run_trivy_scan
    ...
    def test_agent_isolation_module(self):
        from security.agent_isolation import IsolationStatus
...
class TestResourceProtection:
    ...
    def test_subagent_monitor_loaded(self):
        from security.subagent_monitor import SubagentMonitor, SubagentEvent
        assert SubagentMonitor is not None
...
class TestSupplyChain:
    ...
    def test_all_security_modules_importable(self):
        ...
        modules = [
            "security.agent_isolation",
            "security.alert_dispatcher",
            "security.browser_security",
            "security.canary",
            "security.clamav_scanner",
            "security.consent_framework",
            "security.context_guard",
            "security.dns_filter",
            "security.drift_detector",
            "security.egress_filter",
            "security.egress_monitor",
            "security.encrypted_store",
            "security.env_guard",
            "security.falco_monitor",
            "security.file_sandbox",
            "security.git_guard",
            "security.health_report",
            "security.key_vault",
            "security.log_sanitizer",
            "security.metadata_guard",
            "security.network_validator",
            "security.oauth_security",
            "security.prompt_guard",
            "security.resource_guard",
            "security.session_security",
            "security.subagent_monitor",
            "security.token_validation",
            "security.trust_manager",
            "security.wazuh_client",
        ]
        for mod in modules:
            __import__(mod)
