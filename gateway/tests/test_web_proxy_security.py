...
class TestWebProxySecurityIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('gateway.proxy.web_proxy.DNSFilter'), \
            ...
            from gateway.proxy.web_proxy import WebProxy, WebProxyResult, ProxyAction
    ...
    def test_dns_filter_blocks_suspicious_domains(self):
        ...
        # Setup
        self.proxy.url_analyzer.analyze.return_value = MockURLResult(domain="suspicious.example.com")
        self.proxy.dns_filter.check.return_value = MockDNSVerdict(allowed=False, reason="Suspicious domain")
    ...
    def test_dns_filter_flags_but_allows_questionable_domains(self):
        ...
        # Setup
        self.proxy.url_analyzer.analyze.return_value = MockURLResult(domain="questionable.example.com")
        self.proxy.dns_filter.check.return_value = MockDNSVerdict(allowed=True, flagged=True, reason="High entropy")
    ...
    def test_browser_security_blocks_high_risk_urls(self):
        ...
        self.proxy.browser_security.check_url_reputation.assert_called_once_with("https://malicious.example.com/phishing")
    ...
    def test_multiple_security_modules_integration(self):
        ...
        self.proxy.dns_filter.check.return_value = MockDNSVerdict(allowed=True, flagged=True, reason="Entropy")
        self.proxy.browser_security.check_url_reputation.return_value = MockThreatLevel.MEDIUM
