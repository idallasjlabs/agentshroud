...
def prompt_protection():
    ...
    config = {"enabled": True, "fuzzy_threshold": 0.7, "protected_files": []}
...
class TestPromptProtection:
    ...
    def test_infrastructure_redaction(self, prompt_protection):
        ...
        'agentshroud' and 'agentshroud-openclaw' are public branding and NOT redacted.
        """
        test_cases = [
    ...
    def test_product_name_not_redacted(self, prompt_protection):
        """Product name 'agentshroud' and 'agentshroud-openclaw' are public branding — must not be redacted."""
        for text in ["Using AgentShroud gateway", "agentshroud-openclaw is the container name"]:
    ...
    def test_user_id_redaction(self, prompt_protection):
        ...
        test_cases = ["User ID is 1234567890", "Contact @username123", "Telegram ID: 987654321"]
    ...
    def test_protected_content_loading(self):
        ...
        with (
            ...
            config = {"protected_files": ["/path/to/test.md"]}
            pp = PromptProtection(config)
