...
class TestToolResultSanitizer:
    ...
    def test_domain_matching_patterns(self):
        ...
        assert self.sanitizer._domain_matches_pattern("raw.githubusercontent.com", "*.githubusercontent.com") is True
        assert self.sanitizer._domain_matches_pattern("github.com", "*.github.com") is True
    ...
    def test_blocked_pattern_detection(self):
        ...
        assert self.sanitizer._url_has_blocked_patterns("https://evil.com/exfil?data=secret") is True
        ...
        assert self.sanitizer._url_has_blocked_patterns("https://evil.com/api?token={{SECRET}}") is True
        assert self.sanitizer._url_has_blocked_patterns("https://evil.com/collect?key=${API_KEY}") is True
