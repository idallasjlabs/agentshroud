...
import pytest
from gateway.security.outbound_filter import OutboundInfoFilter, InfoCategory, FilterMatch
...
class TestOutboundInfoFilter:
    ...
    def test_internal_url_filtering(self):
        ...
        for url in test_cases:
            ...
            assert "[INTERNAL_URL]" in result.filtered_text or "[INTERNAL_HOST]" in result.filtered_text
    ...
    def test_mcp_tool_filtering(self):
        ...
        sensitive_tools = [
            "exec", "cron", "sessions_send", "subagents", 
            "nodes", "apply_patch", "sessions_list", 
    ...
    def test_credential_path_filtering(self):
        ...
        for cred in test_cases:
            ...
            assert "[SECRET_PATH]" in result.filtered_text or "[CREDENTIAL_VAR]" in result.filtered_text
