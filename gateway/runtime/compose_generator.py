...
logger = logging.getLogger("secureclaw.runtime.compose")
...
DEFAULT_SERVICES = [
    ServiceDef(
        ...
        volumes=["gateway-data:/app/data", "./secureclaw.yaml:/app/secureclaw.yaml:ro"],
        networks=["secureclaw-internal"],
    ...
    ServiceDef(
        name="openclaw",
        image="secureclaw-openclaw:latest",
...
def generate_apple_script(
    ...
    lines = [
        "#!/bin/zsh",
        "# SecureClaw — Apple Containers startup script",
        ...
        "",
        "if [[ \"$ACTION\" == \"up\" ]]; then",
        "  echo \"Starting SecureClaw services...\"",
    ]
    ...
    lines += [
        ...
        '  echo "Stopping SecureClaw services..."',
    ]
