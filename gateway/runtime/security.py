...
SECURITY_FEATURES: list[SecurityFeature] = [
    SecurityFeature(
        ...
        docker=True, podman=True, apple=False,
    ...
    SecurityFeature(
        ...
        docker=False, podman=True, apple=True,
    ...
    SecurityFeature(
        ...
        docker=False, podman=True, apple=False,
    ...
    SecurityFeature(
        ...
        docker=False, podman=False, apple=True,
    ...
    SecurityFeature(
        ...
        docker=True, podman=True, apple=True,
