...
class KeyRotationConfig:
    ...
    policies: Dict[str, CredentialRotationPolicy] = field(
    ...
    # Emergency rotation triggers
    emergency_triggers: Dict[str, bool] = field(
        default_factory=lambda: {
    ...
    def is_emergency_trigger_enabled(self, trigger_type: str) -> bool:
        ...
        return self.enable_emergency_rotation and self.emergency_triggers.get(trigger_type, False)
