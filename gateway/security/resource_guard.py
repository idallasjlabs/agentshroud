...
class ResourceGuard:
    ...
    def check_disk_write_limit(self, agent_id: str) -> bool:
        ...
        try:
            ...
            writes_mb = (current_io.get('write_bytes', 0) - self.baseline_disk_io.get('write_bytes', 0)) / (1024 * 1024)
