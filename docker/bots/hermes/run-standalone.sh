...
cmd_up() {
  ...
  docker run -d \
    ...
    -e AGENTSHROUD_LOCAL_MODEL_REF="${AGENTSHROUD_LOCAL_MODEL_REF:-openai-local/nemotron-3.5-lightning-rapid}" \
    -e AGENTSHROUD_LOCAL_MODEL="${AGENTSHROUD_LOCAL_MODEL:-nemotron-3.5-lightning-rapid}" \
