...
When asked to generate a competitive analysis or competitive intelligence report:
1. Read `competitive-analysis.md` from this workspace first
2. Follow its instructions exactly — 4 sections, verified sources only, no hallucinations
3. Save output to `reports/competitive-report-[YYYY-MM-DD].md`
4. Append a one-line trend summary to `reports/trend-log.md`

Do not generate a competitive report from memory. Always read `competitive-analysis.md` first.
