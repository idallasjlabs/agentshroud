...
**Command:** `/i-sav` (Claude Code) | paste `.gemini/agents/sav.md` (Gemini/Codex)
...
## Usage
Invoke `/i-sav`, then paste your codebase (source files, config files, docker-compose, .env examples, logs, etc.) below the prompt.
