...
**Command:** `/i-sad` (Claude Code) | paste `.gemini/agents/sad.md` (Gemini/Codex)
...
## Usage
Invoke `/i-sad`, then paste your codebase (source files, config files, docker-compose, .env examples, logs, etc.) below the prompt.
