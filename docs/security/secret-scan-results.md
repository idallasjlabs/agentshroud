...
| Token | Found In |
|-------|----------|
| `***REVOKED-GATEWAY-TOKEN***` | `archive/FINAL_CONFIGURATION.md:137`, `archive/ACCESS_INFO.md` (×3), `archive/QUICK_ACCESS.md` (×6), `archive/CONNECT_NOW.md` (×2), `archive/SYSTEM_STATUS.md` (×2), `archive/SETUP_SUMMARY.md` (×2), `archive/session-notes/continue-20260215-1457.md` (×3), `telegram_history.jsonl` (×10+), `.claude/skills/sec-offense/SKILL.md:373` |
| `***REVOKED-GATEWAY-TOKEN***` | `archive/HOW_TO_CONNECT.md` (×3) |
