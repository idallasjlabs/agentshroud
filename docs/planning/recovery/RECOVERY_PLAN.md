...
**Action Required:**
Follow instructions in `docs/setup/IMESSAGE_PERMISSION_FIX.md`:
...
- docs/setup/IMESSAGE_PERMISSION_FIX.md
...
## Troubleshooting
See docs/setup/IMESSAGE_PERMISSION_FIX.md for permission issues.
```
...
- Comprehensive permission documentation (docs/setup/IMESSAGE_PERMISSION_FIX.md)
...
**Document location:** `/Users/ijefferson.admin/Development/agentshroud/docs/planning/RECOVERY_PLAN.md`
