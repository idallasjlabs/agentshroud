...
colima stop && colima start --cpu 8 --memory 12 --disk 200 --network-address
```
...
| `Cannot connect to the Docker daemon` | Colima VM not running | `colima start --cpu 8 --memory 12 --disk 200 --network-address` |
