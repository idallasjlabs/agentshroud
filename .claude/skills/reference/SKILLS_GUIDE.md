...
| UI components & layout | `/ui` | Component design, CSS architecture, responsive patterns |
| UX & interaction design | `/ux` | Information architecture, user flows, usability review |
| Mindmaps & visual knowledge | `/mm` | XMind files, Markmap browser maps, knowledge structuring |
...
├── ui/SKILL.md                    # UI Expert (components, CSS, responsive, a11y)
├── ux/SKILL.md                    # UX Expert (IA, flows, usability, CLI/TUI UX)
├── mm/SKILL.md                    # Mindmap Architect (XMind, Markmap)
└── reference/
...
- **UI** (`/ui`) - UI component design: buttons, forms, modals, data tables, nav; CSS architecture (utility-first/BEM/modules); responsive layouts; dark/light theme; WCAG accessibility
- **UX** (`/ux`) - Information architecture, interaction design patterns, user flow diagrams, form UX, CLI/TUI usability, dashboard UX, Nielsen heuristics audit
- **MM** (`/mm`) - Mindmap generation: XMind files via `xmind-generator-mcp`, interactive browser maps via `markmap-mcp-server`, knowledge structuring, curriculum mapping
